...
?>
<div class="address_book-container">
	<?php
		...
		// Only display if primary addresses are set and not on an edit page.
			if ( ! empty( $woo_address_book_billing_address ) ) {
				...
				<div class="address_book billing_address_book">
					...
					<?php if(empty($woo_address_book_billing_address_book)){ ?>

						<p class="myaccount_address"><?php echo esc_html( apply_filters( 'woocommerce_my_account_my_address_book_description', __( 'You have no address in your address book.', 'woo-address-book' ) ) ); ?></p>
					<?php } ?>
					...
					<div class="col2-set addresses address-book owl-carousel address-slide">
						<?php
							...
							if ( $woo_address_book_formatted_address ) {
								...
								<div class="wc-address-book-address">
									<div class="wc-address-book-meta">
										<a href="<?php echo esc_url( $wc_address_book->get_address_book_endpoint_url( $woo_address_book_name, 'billing' ) ); ?>" class="wc-address-book-edit"><img src="<?php echo get_stylesheet_directory_uri().'/woocommerce/inc/images/edit-01.svg'; ?>" alt="<?php echo esc_attr__( 'Edit', 'woo-address-book' ); ?>"/></a>
										<a id="<?php echo esc_attr( $woo_address_book_name ); ?>" class="wc-address-book-delete"><img src="<?php echo get_stylesheet_directory_uri().'/woocommerce/inc/images/delete-01.svg'; ?>" alt="<?php echo esc_attr__( 'Delete', 'woo-address-book' ); ?>"/></a>
									</div>
									<address>
										<?php echo wp_kses( $woo_address_book_formatted_address, array( 'br' => array() ) ); ?>
									</address>

									<a id="<?php echo esc_attr( $woo_address_book_name ); ?>" class="wc-address-book-make-primary btn"><?php echo esc_attr__( 'Make Default', 'woo-address-book' ); ?></a>
								</div>
		...
		// Only display if primary addresses are set and not on an edit page.
			if ( ! empty( $woo_address_book_shipping_address ) ) {
				...
				<div class="address_book shipping_address_book">
					...
					<?php if( empty($woo_address_book_shipping_address_book)){ ?>
						<p class="myaccount_address">
							<?php echo esc_html( apply_filters( 'woocommerce_my_account_my_address_book_description', __( 'You have no address in your address book.', 'woo-address-book' ) ) ); ?>
						</p>
					...
					if ( ! wc_ship_to_billing_address_only() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) {
						echo '<div class="col2-set addresses address-book owl-carousel address-slide">';
					}
					...
					// Prevent default shipping from displaying here.
						...
						if ( $woo_address_book_formatted_address ) {
							...
							<div class="wc-address-book-address">
								<div class="wc-address-book-meta">
									<a href="<?php echo esc_url( $wc_address_book->get_address_book_endpoint_url( $woo_address_book_name, 'shipping' ) ); ?>" class="wc-address-book-edit"><img src="<?php echo get_stylesheet_directory_uri().'/woocommerce/inc/images/edit-01.svg'; ?>" alt="<?php echo esc_attr__( 'Edit', 'woo-address-book' ); ?>"/></a>
									<a id="<?php echo esc_attr( $woo_address_book_name ); ?>" class="wc-address-book-delete"><img src="<?php echo get_stylesheet_directory_uri().'/woocommerce/inc/images/delete-01.svg'; ?>" alt="<?php echo esc_attr__( 'Delete', 'woo-address-book' ); ?>"/></a>
								</div>
								<address>
									<?php echo wp_kses( $woo_address_book_formatted_address, array( 'br' => array() ) ); ?>
