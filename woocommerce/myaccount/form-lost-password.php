...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row text-center">
		...
		<button type="submit" class="main-btn"  name="login" value="<?php esc_attr_e( 'Reset password', 'woocommerce' ); ?>"><span><div class="main-btn-round"></div>Reset password</span></button>
