...
<head>
    ...
    <title><?php
          ...
          elseif (is_archive()) {
             wp_title('');?> - <?php echo get_bloginfo('name');}
		elseif (is_search()) {
             echo 'Search';?> - <?php echo get_bloginfo('name'); } 
		else {
			echo get_the_title(); ?> - <?php echo get_bloginfo('name');
		}?></title>
...
<body>
    ...
    <!-- header -->
    <header class="second-navigation">
        <div class="top-bar">
            <div class="container">
        ...
        <div class="main-navigation ">
            <div class="container-fluid">
                ...
                <ul class="more-links">
                    ...
                    <li class="mobile-logo mobile-logo1">
                        <a href="index.html" class="navbar-brand">
                            <img src="<?php echo get_template_directory_uri() . '/images/mobilelogo1.svg'?>" class="img-fluid " alt="">
                        </a>
                    </li>
                    ...
                    <li class="web-cart"><a href="cart"><i class="fa-solid fa-bag-shopping"></i></a></li>
